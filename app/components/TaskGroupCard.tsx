        ...
        <div className="flex items-center justify-between p-4 bg-white rounded-lg shadow-lg w-full max-w-md">
            ...
            <div className="relative flex items-center justify-center w-12 h-12">
                <svg className="absolute w-full h-full" viewBox="0 0 36 36">
                    <path
                        className={`${props.taskGroup == "Work" ? "text-pink-100" : props.taskGroup == "Personal" ? "text-[#EDE4FF]" : "text-[#FFE6D4]"}`}
                        strokeWidth="3"
                        stroke="currentColor"
                        fill="none"
                        d="M18 2.0845
                    ...
                    />
                    <path
                        className={`${props.taskGroup == "Work" ? "text-pink-500" : props.taskGroup == "Personal" ? "text-[#9260F4]" : "text-[#FF9142]"}`}
                        strokeWidth="3"
                        strokeLinecap="round"
                        stroke="currentColor"
                        fill="none"
